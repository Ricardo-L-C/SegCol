# copy from https://github.com/StickCui/PyTorch-SE-ResNet/blob/master/model/model.py
import torch
...
class BottleneckX(nn.Module):
    ...
    def __init__(self, inplanes, planes, cardinality=16, stride=1, downsample=None):
...
class SEResNeXt(nn.Module):
    def __init__(self, block, layers, input_channels=3, cardinality=16, num_classes=1000):
